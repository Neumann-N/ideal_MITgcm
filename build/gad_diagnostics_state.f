...
C     som_S  :: Salinity 1rst & 2nd Order Moments
     ...
     &                som_T,
     &                som_S
      Real*8  som_T(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy,nSOM)
      Real*8  som_S(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy,nSOM)
...
C     !LOCAL VARIABLES:
      ...
      Real*8       locVar(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8       recipVol
      Real*8       oneThird, oneFifth, oneNinth
